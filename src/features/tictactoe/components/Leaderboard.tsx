      ...
      >
        ...
        {entries.length === 0 ? (
          ...
          >
            ...
            <p className="text-gray-400 mt-2">Start a game to see scores here!</p>
          </motion.div>
        ) : (
          <motion.div
            initial={{ opacity: 0 }}
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-gray-200">
                  ...
                  <th className="text-center py-3 px-4 font-semibold text-gray-700">W/L/D</th>
                ...
                {entries.map((entry, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3 px-4 text-center text-gray-600">{entry.gamesPlayed}</td>
                      <td className="py-3 px-4 text-center text-gray-600">
                        {entry.wins}/{entry.losses}/{entry.draws}
                      </td>
                      <td className="py-3 px-4 text-center">
                        <span className={`font-medium ${
                          parseFloat(winRate) >= 50 ? 'text-green-600' : 'text-gray-600'
                        }`}>
                          {winRate}%
                        </span>
                      </td>
